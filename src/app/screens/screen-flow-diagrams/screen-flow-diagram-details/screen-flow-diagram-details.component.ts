...
import {
  Connector, ConnectorModel, Diagram,
  FlowShapeModel, IDragEnterEventArgs,
  MarginModel, NodeModel,
  OrthogonalSegmentModel, PaletteModel, PointPortModel, SnapSettingsModel,
  StrokeStyleModel, SymbolInfo,
  TextStyleModel, UndoRedo
} from "@syncfusion/ej2-diagrams";
import {ExpandMode} from "@syncfusion/ej2-navigations";
import {paletteIconClick} from "../../use-case-diagram/use-case-diagram-canvas/diagram-common";
Diagram.Inject(UndoRedo);

@Component({
  selector: 'app-screen-flow-diagram-details',
  templateUrl: './screen-flow-diagram-details.component.html',
  styleUrls: ['./screen-flow-diagram-details.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class ScreenFlowDiagramDetailsComponent {
  @ViewChild('diagram')
  //Diagram Properties
  ...
  public margin: MarginModel = { left: 0, right: 0 };
